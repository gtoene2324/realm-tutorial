...
function useTeamMembers() {
  ...
  // Implement the function updateTeamMembers so that it calls getMyTeamMembers and updatesthe team variable with the current team members.
  ...
  return {
    ...
    // Call the addTeamMember() function and return updateTeamMembers if  addTeamMember() was successful.
